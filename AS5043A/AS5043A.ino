...
void loop(){
  ...
  delay(1);                       // wait for x seconds for no particular reason
  ...
  //Serial.println(angle, DEC);
  angP = (double)(angle) * 0.3515; // angle * (360/1024) == actual degrees
  Serial.print("angle: "); // and, finally, print it.
  Serial.print(angP, DEC);
  Serial.print("\tmedicao: "); // and, finally, print it.
  Serial.println(angle, DEC);
  Serial.print("\n");
